<x-layouts.app :title="__('Courses')">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        ...
        <div class="relative h-full flex-1 overflow-hidden rounded-xl border border-neutral-200 bg-gray-50 dark:border-neutral-700 dark:bg-neutral-800">
            <div class="flex h-full flex-col p-6">

                <div class="mb-6 rounded-lg border border-neutral-200 bg-gray-100 p-6 dark:border-neutral-700 dark:bg-neutral-900/50">
                    <h2 class="mb-4 text-lg font-semibold text-neutral-900 dark:text-neutral-100">Add New Course</h2>
                        ...
                        <table class="w-full min-w-full">
                            <thead>
                                <tr class="border-b border-neutral-200 bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-900/50">
                                    ...
                                    <th class="px-4 py-3 text-center text-sm font-semibold text-neutral-700 dark:text-neutral-300">Course Name</th>
                            ...
                            <tbody class="divide-y divide-neutral-200 dark:divide-neutral-700">
                                @forelse($courses as $course)
                                    <tr class="transition-colors hover:bg-neutral-50 dark:hover:bg-neutral-800/50" id="course-row-{{ $course->id }}">
                                        ...
                                        <td class="px-4 py-3 text-center text-sm text-neutral-600 dark:text-neutral-400">
                                            <span class="course-description-display">{{ Str::limit($course->description, 50) ?? 'N/A' }}</span>
                                        </td>
                                        <td class="px-4 py-3 text-center text-sm">
                                            <button onclick="editCourse({{ $course->id }}, '{{ $course->course_name }}', '{{ addslashes($course->description) }}')"
    ...
    <div id="editCourseModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50">
        <div class="w-full max-w-2xl rounded-xl border border-neutral-200 bg-white p-6 dark:border-neutral-700 dark:bg-neutral-800">
            <h2 class="mb-4 text-lg font-semibold text-neutral-900 dark:text-neutral-100">Edit Course</h2>
