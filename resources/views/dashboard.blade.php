<x-layouts.app :title="__('Dashboard')">
 ...
 <style>
    ...
    body {
        background-color: hsla(0, 0%, 51%, 1.00) !important;
    ...
    <style>
    /* Flash success message color */
    .alert-success,
    .text-green-500,
    .text-success {
        color: #00ff88 !important; /* bright neon green */
        font-weight: 600;
    }

    /* Optional: subtle glow effect around the text */
    .alert-success {
